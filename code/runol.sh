...
save_path='/home/lez/Documents/QT/QT/results/drawdown/vote(tcasm)'
...
# python3 $pyfile --forcast --method $method --folder_mode --data $data --save_path $save_path --config $setting
